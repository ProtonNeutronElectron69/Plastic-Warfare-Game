/* ---------------- ASSET MANIFEST & LOADER ----------------
   ...
   from SND_B64, and v95 (phase 4) began filling img from IMG_B64 - the
   faction-exclusive unit and structure of each army first, the rest one
   texture at a time.
...
const ASSET_MANIFEST={
 /* name -> url. snd is filled by 02c-snd-data.js and img by 02d-img-data.js,
    ...
    bld_<key>_<fac> - one png per sprite cell, at the cell's own box and
