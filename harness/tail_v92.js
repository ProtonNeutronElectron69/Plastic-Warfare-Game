...
/* ---------- E: the repository cannot drift ---------- */
{
  ...
  /* v95 grew this run by the image data, v96 by the normal maps, v104 by the
     music (02f) - each a conscious line, never a loosening. The music data
     sits LAST of the asset files and still ahead of 03-audio.js, because all
     it does is fill a manifest; the player that reads it (03b-music.js) needs
     sndLead, AC and masterGain and so ships after the audio engine. */
