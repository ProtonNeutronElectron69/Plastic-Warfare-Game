#!/usr/bin/env python3
"""repin_v83.py - write the recut_v83 tables into the tails that pin them.

    cat shim_head.js game.js recut_v83.js > rc83.js && node rc83.js > cut_v83.json
    python3 repin_v83.py cut_v83.json
...
CUT = sys.argv[1] if len(sys.argv) > 1 else 'cut_v83.json'
...
if cut['BASE45_TRAILS'] != cut['BASE62_TRAILS']:
    sys.exit('the two tan tables disagree - recut_v83 should have caught this')
